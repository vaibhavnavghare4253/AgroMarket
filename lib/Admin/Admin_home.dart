...
import '../screens/home_screen/drawer_side.dart'; // Import the drawer widget
...
class _AdminPanelState extends State<AdminPanel> {
  ...
  final TextEditingController _stockController = TextEditingController(); // New
  ...
  void _addProduct() {
    ...
    int? stock = int.tryParse(_stockController.text.trim()); // New

    if (name.isNotEmpty && price != null && imageUrl.isNotEmpty && stock != null) {
      _firestore.collection(_selectedCollection).add({
        'productName': name,
        'productPrice': price,
        'productImage': imageUrl,
        'stock': stock, // New field
        ...
        _stockController.clear(); // Clear new field
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // drawer: DrawerSide(), // Add the drawer here if needed
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(labelText: 'Stock'), // New field
              keyboardType: TextInputType.number,
            ),
            SizedBox(height: 16),
            ElevatedButton(
