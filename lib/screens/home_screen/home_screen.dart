...
//     final productProvider = Provider.of<ProductProvider>(context, listen: false);
//
//     // ✅ Fetch data only if lists are empty to avoid multiple calls
//     if (productProvider.getGrainsProductDataList.isEmpty) {
//       productProvider.listenToGrainsProductData();
//     }
//     if (productProvider.getFruitsProductDataList.isEmpty) {
//       productProvider.listenToFruitsProductData();
//     }
//     if (productProvider.getVegetablesProductDataList.isEmpty) {
//       productProvider.listenToVegetablesProductData();
//     }
//   }
//
